...
---------------------------------------------------------------------------------------------------------------------------*/
    ...
    BEGIN
        ...
        BEGIN TRY
            ...
            DROP TABLE IF EXISTS Placements_Wrk.ItemStatus_WOP;
        
            Drop Table IF EXISTS Placements_Wrk.Weekly_History_tmp;    
            ...
            CREATE TABLE Placements_Wrk.Weekly_History_tmp
                (
                    [Year]     SMALLINT,
                    [Week]     INT,
                    WeekDate   DATE,
            ...
            INSERT INTO Placements_Wrk.Weekly_History_tmp
                (
                    Year,
                    Week,
                    WeekDate,
                    ...
                    Lost
                        ...
                        FROM
                            ...
                            JOIN
                               [$(MasterData_Warehouse)].MasterData_DW.DimItemMaster
                                    ON[$(MasterData_Warehouse)].MasterData_DW.DimItemMaster.ItemSKU = InvoiceDetail.ItemSKU
                                       AND[$(MasterData_Warehouse)].MasterData_DW.DimItemMaster.KeyItem = 1
                            JOIN
                                [$(MasterData_Warehouse)].MasterData_DW.DimDate_NonRetail D1
                                    ON D1.[DateID] = InvoiceDetail.ActualDelivery
                            JOIN
                ...
                (
                    ...
                    Lost
                        ...
                        FROM
                            ...
                            JOIN
                                [$(MasterData_Warehouse)].MasterData_DW.DimDate_NonRetail D1
                                    ON [DateID] = InvoiceDetail.[ActualDelivery]
                            JOIN
                                [$(MasterData_Warehouse)].MasterData_DW.DimDate_NonRetail WD
                                    ON D1.[FiscalYear] = WD.[FiscalYear]
                                       AND D1.[FiscalWeek] = WD.[FiscalWeek]
                        ...
                        FROM
                                (
                                    SELECT
                                            ...
                                            0         AS OrderAmt
                                    FROM
                                            Placements_Wrk.Weekly_History_tmp t1
                                        JOIN
                                            [$(MasterData_Warehouse)].MasterData_DW.DimDate_NonRetail
                                                ON [DateID]
                            ...
                            LEFT JOIN
                                Placements_Wrk.Weekly_History_tmp t2
                ...
                (
                    ...
                    Lost
                        ...
                        FROM
                            ...
                            LEFT JOIN
                                Placements_Wrk.Weekly_History_tmp FW
                ...
                (
                    ...
                    Week
                        ...
                        SELECT
                                ...
                                h.Week
                        FROM
                                Placements_Wrk.Weekly_History_tmp                                       h
                            JOIN
                            ...
                            LEFT JOIN
                                Placements_Wrk.Weekly_History_tmp                                       PW
                                    ON PW.WeekDate =  DATEADD(DAY, -7, h.WeekDate )
                                       AND h.CustomerNumber = PW.CustomerNumber
                                       AND h.ShiptoNumber = PW.ShiptoNumber
                                       AND h.ItemSKU = PW.ItemSKU
                        WHERE
                                h.WeekDate
                        BETWEEN DATEADD(DAY, -2190,CAST( GETDATE() AS DATE)) AND @DateValue;
            ...
            DROP TABLE Placements_Wrk.Weekly_History_tmp;
