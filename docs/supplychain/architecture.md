...
**Pipelines**: 6 (`pl_sc_master`, `pl_sc_bronze`, `pl_sc_silver`, `pl_sc_silver_wave`, `pl_sc_gold`, `pl_dq_check`)

**Grand total**: ~85 warehouse objects + 7 pipelines = **~92 managed artifacts**
