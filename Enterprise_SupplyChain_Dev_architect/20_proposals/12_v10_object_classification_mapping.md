...
Detailed cutover and rollback rules are defined in `Enterprise_SupplyChain_Dev_architect/30_runbook/15_v10_edw_supplement_exit_strategy.md` and formalized in `docs/decisions/ADR-002-edw-supplement-exit-strategy.md`.
