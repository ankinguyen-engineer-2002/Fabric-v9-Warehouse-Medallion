...
| 7 | Metadata-driven ETL | "Metadata-driven frameworks enable incremental ingestion at scale" | AssetRegistryV10, 8 load patterns, 1 generic SP for all tables | **10/10** | Exceeds: MS mentions metadata-driven; v10 has full control plane |
