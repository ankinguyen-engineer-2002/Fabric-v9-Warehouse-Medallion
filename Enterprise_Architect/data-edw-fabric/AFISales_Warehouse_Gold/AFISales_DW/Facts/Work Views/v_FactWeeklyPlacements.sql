CREATE VIEW [AFISales_DW_Wrk].[v_FactWeeklyPlacements]
AS
  ...
  WITH PlacementWeekDate
   ...
   SELECT
            ...
            D1.WeekEndedDate                    AS [Week Ended],
            C.[Shipto AddressID],
            ...
            T.[AFI Sales Category],
            T.[AFI Sales Division Code],
            T.[AFI Sales Region Code],
            T.[AFI Sales RepID],
            T.RegionCode_RepID_Category,
            CASE
                WHEN CAST(C.[Shipto Sales Territory] AS INT) = 0
                    THEN
                    C.[Primary Sales Territory]
                ELSE
                    C.[Primary Sales Territory] + C.[Shipto Sales Territory]
            END                                    AS Territory,
            C.[Store Address ID],
            RTRIM(C.[Customer Account Number]) + '-' + RTRIM(C.[Customer Shipto Number]) + '-'
            + T.[AFI Sales Division Code]          AS [Customer Shipto Division Number],
            C.[Customer Account Number],
            C.[Customer Shipto Number]
    FROM
            AFISales_Enh.CustItemWeeklyPlacements C1
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P1
                ON C1.ItemSKU = P1.ItemSKU
                   ...
                   AND P1.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P2
                ON C1.ItemSKU = P2.ItemSKU
                   ...
                   AND P2.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P3
                ON C1.ItemSKU = P3.ItemSKU
                   ...
                   AND P3.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P4
                ON C1.ItemSKU = P4.ItemSKU
                   ...
                   AND P4.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P5
                ON C1.ItemSKU = P5.ItemSKU
                   ...
                   AND P5.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P6
                ON C1.ItemSKU = P6.ItemSKU
                   ...
                   AND P6.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P7
                ON C1.ItemSKU = P7.ItemSKU
                   ...
                   AND P7.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P8
                ON C1.ItemSKU = P8.ItemSKU
                   ...
                   AND P8.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P9
                ON C1.ItemSKU = P9.ItemSKU
                   ...
                   AND P9.Week = CASE
                                    ...
                                    END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P10
                ON C1.ItemSKU = P10.ItemSKU
                   ...
                   AND P10.Week = CASE
                                     ...
                                     END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P11
                ON C1.ItemSKU = P11.ItemSKU
                   ...
                   AND P11.Week = CASE
                                     ...
                                     END
        LEFT JOIN
            AFISales_Enh.CustItemWeeklyPlacements P12
        ...
        JOIN
            AFISales_DW.DimCustomers              C
                ON C.[Customer Account Number] = C1.CustomerNumber
                   AND C.[Customer Shipto Number] = C1.ShiptoNumber
        LEFT JOIN
        ...
        JOIN
            PlacementWeekDate                    D1
                ON D1.YearWeek = C1.YearWeek
        LEFT JOIN
            AFISales_DW.[DimSalesTerritories]     T
                ON T.[AFI Sales Region Code] = ISNULL(MrktSpclstAcctOwnershipSlsCat.Region, CAST('Z' AS CHAR(3)))
                   AND T.[AFI Sales RepID] = ISNULL(MrktSpclstAcctOwnershipSlsCat.RepID, CAST('ZZZZZ' AS CHAR(5)))
                   AND T.[AFI Sales Category] = CASE
