CREATE       PROCEDURE [PowerBI_Retail].[usp_Refresh_Retail_FactSalesAttachmentSummaryMbsPil]
(@TransDate DATE)
AS
BEGIN
 ...
 @String VARCHAR(5000),
    ...
    SET @String = 'PowerBI_Retail.usp_Refresh_Retail_FactSalesAttachmentSummaryMbsPil';
    ...
    SELECT mpb.LocationID,
           mpb.TransDate,
           mpb.SalesPersonID,
           SUM(mpb.HasPIL * ABS(mpb.HasMBS)) AS AttachedValue,
    ...
    (
        ...
        --MAX(CASE WHEN dsdt.GroupID = 'PIL' THEN 1 ELSE 0 END) AS HasPIL,
