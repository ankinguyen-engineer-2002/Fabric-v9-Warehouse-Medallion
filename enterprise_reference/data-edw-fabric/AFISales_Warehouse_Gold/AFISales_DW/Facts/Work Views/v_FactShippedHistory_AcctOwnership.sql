...
CREATE VIEW [AFISales_DW_Wrk].[v_FactShippedHistory_AcctOwnership]
AS
        ...
        (
            SELECT
                    ...
                    [Quantity Shipped]                                    = CASE
                                                                                WHEN InvoiceDetail.[CreditCode] NOT IN (
                                                                                    ...
                                                                                    CAST(InvoiceDetail.[QuantityShipped]
                                                                                         * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1) AS DECIMAL(11, 3))
                                                                                ELSE
                                                                                    00000.000
                                                                            END,                                                                                   --Fact Invoice
                    [Invoice Discount]                                    = CAST((InvoiceDetail.[Discount] * InvoiceDetail.[QuantityShipped])
                                                                                 * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1) AS DECIMAL(13, 3)), --Fact Invoice
                    ...
                    * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1)
                    ...
                    [Invoiced Line Item Freight]                          = CAST((InvoiceDetail.[Freight] * InvoiceDetail.[QuantityShipped])
                                                                                 * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1) AS DECIMAL(9, 3)),  --Fact Invoice
                    ...
                    [Advertising Accrual]                                 = CAST(ISNULL(
                                                                                           ...
                                                                                           * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1), 0
                    ...
                    * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1)
                    ...
                    [Delivery Days]                                       = CASE
                                                                            ...
                                                                            END,
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays IS NULL THEN 0 ELSE QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) END  AS [Stm Base Calc]
                    CASE
                        WHEN
                            (
                                InvoiceDetail.[DeliveryDays] IS NOT NULL
                            ...
                            THEN
                            InvoiceDetail.[QuantityShipped] * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1)
                        ELSE
                            0
                    END                                                   AS [Stm Base Calc],

                                                                                                                                                                   --CASE WHEN DeliveryDays IS NULL THEN 0 ELSE 1 * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1)  END AS [Stm Count] 
                    CASE
                        WHEN
                            (
                                InvoiceDetail.[DeliveryDays] IS NOT NULL
                            ...
                            THEN
                            1 * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1)
                        ELSE
                            0
                    END                                                   AS [Stm Count],


                                                                                                                                                                   --CASE WHEN DeliveryDays < 0 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [Early]
                    ...
                    END                                                   AS [Early],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays = 0 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [On Time]
                    ...
                    END                                                   AS [On Time],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays = 1 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [1 Day Late]
                    CASE
                        WHEN
                            (
                    ...
                    END                                                   AS [1 Day Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays = 2 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [2 Days Late]
                    CASE
                        WHEN
                            (
                    ...
                    END                                                   AS [2 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays = 3 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [3 Days Late]
                    CASE
                        WHEN
                            (
                    ...
                    END                                                   AS [3 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays = 4 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [4 Days Late]
                    ...
                    END                                                   AS [4 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays = 5 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [5 Days Late]
                    CASE
                        WHEN
                            (
                    ...
                    END                                                   AS [5 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays = 6 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [6 Days Late]
                    CASE
                        WHEN
                            (
                    ...
                    END                                                   AS [6 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays = 7 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [7 Days Late]
                    ...
                    CASE
                        ...
                        ELSE
                            0
                    END                                                   AS [7 Days Late],
                                                                                                                                                                   --CASE WHEN DeliveryDays BETWEEN 8 AND 14 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [8 to 14 Days Late]
                    ...
                    END                                                   AS [8 to 14 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays BETWEEN 15 AND 21 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [15 to 21 Days Late]
                    ...
                    END                                                   AS [15 to 21 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays BETWEEN 22 AND 28 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [22 to 28 Days Late]
                    ...
                    END                                                   AS [22 to 28 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays > 28 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [Over 28 Days Late]
                    ...
                    END                                                   AS [Over 28 Days Late],
                                                                                                                                                                   ...
                                                                                                                                                                   ---CASE WHEN DeliveryDays_OrigProm < 0 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [Early - Promised]
                    ...
                    END                                                   AS [Early - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm = 0 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [On Time - Promised]
                    ...
                    END                                                   AS [On Time - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm = 1 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [1 Day Late - Promised]
                    ...
                    END                                                   AS [1 Day Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm = 2 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [2 Days Late - Promised]
                    ...
                    END                                                   AS [2 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm = 3 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [3 Days Late - Promised]
                    ...
                    END                                                   AS [3 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm = 4 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [4 Days Late - Promised]
                    ...
                    END                                                   AS [4 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm = 5 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [5 Days Late - Promised]
                    ...
                    END                                                   AS [5 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm = 6 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [6 Days Late - Promised]
                    ...
                    END                                                   AS [6 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm = 7 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [7 Days Late - Promised]
                    ...
                    END                                                   AS [7 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm BETWEEN 8 AND 14 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [8 to 14 Days Late - Promised]
                    ...
                    END                                                   AS [8 to 14 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm BETWEEN 15 AND 21 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [15 to 21 Days Late - Promised]
                    ...
                    END                                                   AS [15 to 21 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm BETWEEN 22 AND 28 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [22 to 28 Days Late - Promised]
                    ...
                    END                                                   AS [22 to 28 Days Late - Promised],
                                                                                                                                                                   ...
                                                                                                                                                                   --CASE WHEN DeliveryDays_OrigProm > 28 THEN QuantityShipped * isnull(MrktSpclstAcctOwnershipSlsCat.Ratio,1) ELSE 0 END AS [Over 28 Days Late - Promised]
                ...
                LEFT JOIN
                    AFISales_Enh.MrktSpclstAcctOwnershipSlsCat
                        ON AFISalesDivisionCode = MrktSpclstAcctOwnershipSlsCat.Division
                           AND InvoiceHeader.CustomerNumber = MrktSpclstAcctOwnershipSlsCat.CustomerNumber
                           AND CASE
                                   WHEN [Account Exception Flag] = 0
                                       THEN
                                       ''
                                   WHEN [Account Exception Flag] = 1
                                       THEN
                                       InvoiceHeader.ShiptoNumber
                                   ELSE
                                       ''
                                                                                ...
                                                                                WHEN InvoiceDetail.[CreditCode] NOT IN (
                                                                                    ...
                                                                                    CAST(CASE
                                                                                             WHEN ISNULL(CreditCodes.AllocationCode, '') = 'GROSS'
                                                                                                 THEN
                    (ShippedHistoryCommAdjustment.[ExceptionAmount] * InvoiceDetail.[QuantityShipped])
                    * ISNULL(MrktSpclstAcctOwnershipSlsCat.Ratio, 1)
                                                                                             ELSE
                                                                                                 0
                                                                                         END AS DECIMAL(12,3))
            ...
            FROM
                ...
                LEFT JOIN
                    AFISales_Enh.MrktSpclstAcctOwnershipSlsCat
                        ON AFISalesDivisionCode = MrktSpclstAcctOwnershipSlsCat.Division
                           AND InvoiceDetail.CustomerNumber = MrktSpclstAcctOwnershipSlsCat.CustomerNumber
                           AND CASE
                                   WHEN [Account Exception Flag] = 0
                                       THEN
                                       ''
