CREATE VIEW [AFISales_DW_Wrk].[v_FactQualityCosts]
AS
    ...
    AS (
           SELECT
                   ...
                   [Parts Shipped Quantity - No Charge]    = CASE
                                                                 WHEN ReplacementPartDetail.ChargeType IN (
                                                                                    'N', 'F'
                                                                                )
                                                                     THEN
    ...
    FROM
        (
            SELECT
                    ...
                    CAST(QualityCostsDetail.Quantity * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS DECIMAL(9, 3)) AS [Total Quality Quantity],
                    ...
                    CAST((CASE
                              ...
                              ELSE
                                  0
                          END
                         ) * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS DECIMAL(9, 3))                           [Return Quantity],
                    CAST((CASE
                              WHEN QualityCostsDetail.CreditCode = 'R'
                                  THEN
                                  0
                              ELSE
                                  QualityCostsDetail.Quantity
                          END
                         ) * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS DECIMAL(9, 3))                           AS [Short Ship Quantity],
                    CAST((CASE
                              WHEN QualityCostsDetail.CreditCode = 'R'
                                  THEN
                    (QualityCostsDetail.Quantity)
                    * (QualityCostsDetail.Price - QualityCostsDetail.Freight - QualityCostsDetail.Adjust
                       + QualityCostsDetail.Discount
                              ...
                              ELSE
                                  0
                          END
                         ) * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS DECIMAL(9, 3))                           AS [Returns Amount],
                    CAST((CASE
                              WHEN QualityCostsDetail.CreditCode = 'R'
                                  THEN
                                  0
                    ...
                    * (QualityCostsDetail.Price - QualityCostsDetail.Freight - QualityCostsDetail.Adjust
                       + QualityCostsDetail.Discount
                          ...
                          END
                         ) * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS DECIMAL(9, 3))                           AS [Short Ship Amount],
                    CAST((CASE
                              WHEN QualityCostsDetail.CreditCode = 'R'
                                  THEN
                    (QualityCostsDetail.Quantity)
                    ...
                    * (QualityCostsDetail.Price - QualityCostsDetail.Freight - QualityCostsDetail.Adjust
                       + QualityCostsDetail.Discount
                            ...
                            END
                           ) * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS DECIMAL(9, 3))                         AS [Total Quality Costs],
            ...
            SELECT
                    ...
                    QualityCostsDetail.Quantity * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1),
                    (QualityCostsDetail.QualityCredQnty * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1)) * -1,
                    (CASE
                     ...
                     END
                    ) * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS QualityCredits,
                    ...
                    (CASE
                     ...
                     END
                    ) * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS [ToTerritoryAllocationStatic. Quality Costs],
                    RTRIM(DimCustomers.[Customer Account Number]) + '-' + RTRIM(DimCustomers.[Customer Shipto Number])
                    + '-' + DimSalesTerritories.[AFI Sales Division Code]           AS [Customer Shipto Division Number]
            FROM
                    [$(Wholesale_Warehouse)].Quality_AFI.QualityCostsDetail
            ...
            SELECT
                    ...
                    * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS [Replacement Part Orders],
                    ...
                    * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS [Replacement Part Quantity],
                    ...
                    * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS [Replacement Part Cost],
                    (ISNULL(ReplacementPartHistory.[Parts Shipped Quantity - No Charge], 0)
                     + ISNULL(ReplacementPartHistory.[Parts Shipped Quantity - Charged Back], 0)
                    )
                    * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS [ToTerritoryAllocationStatic. Quality Quantity],
                    0,
                    0,
                    ISNULL(ReplacementPartHistory.[Replacement Part Incidents], 0)
                    * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS [Replacement Part Incidents],
                    0,
                    0,
                    0,
                    0,
                    ...
                    * ISNULL(TerritoryAllocationStatic.CommissionSplitPercent, 1) AS [ToTerritoryAllocationStatic. Quality Cost],
                    RTRIM(DimCustomers.[Customer Account Number]) + '-' + RTRIM(DimCustomers.[Customer Shipto Number])
                    + '-' + DimSalesTerritories.[AFI Sales Division Code]         AS [Customer Shipto Division Number]
            FROM
                    ReplacementPartHistory
                JOIN
                    AFISales_DW.DimCustomers
