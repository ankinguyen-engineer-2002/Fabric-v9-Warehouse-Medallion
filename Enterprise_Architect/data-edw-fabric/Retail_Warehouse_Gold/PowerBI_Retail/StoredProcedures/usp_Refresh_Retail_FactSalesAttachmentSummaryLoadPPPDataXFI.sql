...
CREATE       PROCEDURE  [PowerBI_Retail].[usp_Refresh_Retail_FactSalesAttachmentSummaryLoadPPPDataXFI]
(@TransDate DATE)
AS
BEGIN
    ...
    SET @String = 'PowerBI_Retail.usp_Refresh_Retail_FactSalesAttachmentSummaryLoadPPPDataXFI';
